...
<div class="search-box clearfix we7-margin-bottom">
	<form action="" class="search-form" method="get">
		...
		<select name="groupid" class="pull-left we7-margin-right">
			...
			<option value="<?php  echo $group['id'];?>" data-url="<?php  echo filter_url('groupid:'.$group['id']);?>" <?php  if($group['id'] == $_GPC['groupid']) { ?> selected="selected"<?php  } ?>><?php  echo $group['name'];?></option>
			<?php  } } ?>
		</select>
