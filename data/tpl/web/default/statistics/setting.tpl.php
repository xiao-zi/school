		...
		<div class="panel-body">
			<div class="statistics-box">
				<div class="item">
					...
					<div class="number">
						<span><?php  echo $highest_api_visit;?></span>次<i data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="月API访问总量包括系统免费流量和自行购买的流量。月免费流量每月清0，自行购买流量不清0" class="wi wi-info color-red"></i>
					</div>
					<ul class="info">
						<li >
						...
						<li >
							<span class="color-red">付费流量</span>剩余：<?php  echo $order_num;?>
