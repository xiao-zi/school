...
<ul class="nav nav-tabs">
    <li class="qx_edit <?php  if($operation == 'post') { ?>active<?php  } ?>"><a href="<?php  echo $this->createWebUrl('theclass', array('op' => 'post', 'schoolid' => $schoolid))?>">
		<?php  if(keep_sk77()) { ?>
			添加项目
		<?php  } else { ?>
			添加班级
    ...
    <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('theclass', array('op' => 'display', 'schoolid' => $schoolid))?>">
	<?php  if(keep_sk77()) { ?>
		项目管理
	<?php  } else { ?>
		班级管理
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
						...
						<?php  if(is_showgkk()) { ?>
						<td ><a class="btn btn-default btn-sm " onclick="setbjstar(<?php  echo $row['sid'];?>)"  title="班级之星设置"><i class="fa fa-qrcode">&nbsp;&nbsp;班级之星设置</i></a></td>
						<?php  } ?>
						<td ><a class="btn btn-default btn-sm " onclick="setchecksend(<?php  echo $row['sid'];?>)"  title="考勤推送设置"><i class="fa fa-qrcode">&nbsp;&nbsp;考勤推送设置</i></a></td>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" name="star_name1" id="star_name1" maxlength="4" class="form-control" value="<?php  echo $this_teacher['id'];?>" />
								</div>
								<label class="col-xs-12 col-sm-3 col-md-2 control-label">称号2</label>
								<div class="col-sm-2">
									<input type="text" name="star_name2" id="star_name2" maxlength="4" class="form-control" value="<?php  echo $this_teacher['id'];?>" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" name="star_name3" id="star_name3" maxlength="4" class="form-control" value="<?php  echo $this_teacher['id'];?>" />
								</div>

								<label class="col-xs-12 col-sm-3 col-md-2 control-label">称号4</label>
								<div class="col-sm-2">
									<input type="text" name="star_name4" id="star_name4" maxlength="4" class="form-control" value="<?php  echo $this_teacher['id'];?>" />
								</div>
							</div>
