...
<ul class="nav nav-tabs">
  <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('type', array('op' => 'display'))?>">管理学校类型</a></li>
</ul>
<?php  if($operation == 'post') { ?>
<a class="btn btn-primary" href="<?php  echo $this->createWebUrl('type', array('op' => 'display'))?>"><i class="fa fa-tasks"></i> 返回类型列表</a>
<div class="main">
...
<div class="main">
    <div class="panel panel-default">
        <div class="panel-body">
		    <a class="btn btn-primary" href="<?php  echo $this->createWebUrl('type', array('op' => 'post'))?>"><i class="fa fa-plus"></i> 添加学校类型</a>
