<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
	<label class="radio-inline">
		<input type="radio" name="saturdayset" checked id="one_four"><?php  if($checksetinfo['friday'] == 0 ) { ?>周一至周五<?php  } else { ?>周一至周四<?php  } ?>
	</label>
	<label class="radio-inline"<?php  if($checksetinfo['friday'] == 0 ) { ?>style="display:none"<?php  } ?>>
		<input type="radio" name="saturdayset" id="friday">星期五
	</label>
	<label class="radio-inline" <?php  if($checksetinfo['saturday'] == 0 ) { ?>style="display:none"<?php  } ?>>
		<input type="radio" name="saturdayset" id="saturday">星期六
	</label>
	<label class="radio-inline" <?php  if($checksetinfo['sunday'] == 0 ) { ?>style="display:none"<?php  } ?>>
		<input type="radio" name="saturdayset" id="sunday">星期天
	</label>
</div>
<form id="form">
	<div class="panel-body" id="one_four_div">
		<?php  if(is_array($workdayset)) { foreach($workdayset as $item) { ?>
		<div class="form-group line_boxsss">
			<input type="hidden" name="one_four[id][]" value="<?php  echo $item['id'];?>">
			...
			<div class="col-sm-2 col-lg-2 frisset">
				<select name="one_four[out_in][]">
					...
					<option value="1" <?php  if($item['out_in'] == 1) { ?>selected="selected"<?php  } ?>>进</option>
					<option value="2" <?php  if($item['out_in'] == 2) { ?>selected="selected"<?php  } ?>>出</option>
				</select>
			</div>
			<div class="col-sm-2 col-lg-2">
				<a href="javascript:;" class="custom-url-del delteclassicon" data-id="<?php  echo $item['id'];?>"><i class="fa fa-times-circle"></i></a>
				<select name="one_four[s_type][]">
					<option value="">学生类型</option>
					<option value="1" <?php  if($item['s_type'] == 1) { ?>selected="selected"<?php  } ?>>走读生</option>
					<option value="2" <?php  if($item['s_type'] == 2) { ?>selected="selected"<?php  } ?>>住校生</option>
					<option value="3" <?php  if($item['s_type'] == 3) { ?>selected="selected"<?php  } ?>>半通生</option>
				</select>
			</div>
		</div>
		<?php  } } ?>
	...
	<div class="panel-body" id="friday_div" style="display:none">
		<?php  if(is_array($fridayset)) { foreach($fridayset as $item_f) { ?>
		<div class="form-group line_boxsss">
			<input type="hidden" name="friday[id][]" value="<?php  echo $item_f['id'];?>">
			<div class="input-group clocknews">
				<div class="input-group clockpicker clocknew">
					<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
			...
			<div class="col-sm-2 col-lg-2 frisset">
				<select name="friday[out_in][]">
					<option value="">方向</option>
					<option value="1" <?php  if($item_f['out_in'] == 1) { ?>selected="selected"<?php  } ?>>进</option>
					<option value="2" <?php  if($item_f['out_in'] == 2) { ?>selected="selected"<?php  } ?>>出</option>
				</select>
			</div>
			<div class="col-sm-2 col-lg-2">
				<a href="javascript:;" class="custom-url-del delteclassicon" data-id="<?php  echo $item_f['id'];?>"><i class="fa fa-times-circle"></i></a>
				<select name="friday[s_type][]">
					<option value="">选择学生</option>
					<option value="1" <?php  if($item_f['s_type'] == 1) { ?>selected="selected"<?php  } ?>>走读生</option>
					<option value="2" <?php  if($item_f['s_type'] == 2) { ?>selected="selected"<?php  } ?>>住校生</option>
					<option value="3" <?php  if($item_f['s_type'] == 3) { ?>selected="selected"<?php  } ?>>半通生</option>
				</select>
			</div>
		</div>
		<?php  } } ?>
	...
	<div class="panel-body" id="saturday_div" style="display:none">
		<?php  if(is_array($saturdayset)) { foreach($saturdayset as $item_Sat) { ?>
		<div class="form-group line_boxsss">
			<input type="hidden" name="saturday[id][]" value="<?php  echo $item_Sat['id'];?>">
			<div class="input-group clocknews">
				<div class="input-group clockpicker clocknew">
					<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
			...
			<div class="col-sm-2 col-lg-2 frisset">
				<select name="saturday[out_in][]">
					<option value="">方向</option>
					<option value="1" <?php  if($item_Sat['out_in'] == 1) { ?>selected="selected"<?php  } ?>>进</option>
					<option value="2" <?php  if($item_Sat['out_in'] == 2) { ?>selected="selected"<?php  } ?>>出</option>
				</select>
			</div>
			<div class="col-sm-2 col-lg-2">
				<a href="javascript:;" class="custom-url-del delteclassicon" data-id="<?php  echo $item_Sat['id'];?>"><i class="fa fa-times-circle"></i></a>
				<select name="saturday[s_type][]">
					<option value="">选择学生</option>
					<option value="1" <?php  if($item_Sat['s_type'] == 1) { ?>selected="selected"<?php  } ?>>走读生</option>
					<option value="2" <?php  if($item_Sat['s_type'] == 2) { ?>selected="selected"<?php  } ?>>住校生</option>
					<option value="3" <?php  if($item_Sat['s_type'] == 3) { ?>selected="selected"<?php  } ?>>半通生</option>
				</select>
			</div>
		</div>
		<?php  } } ?>
	...
	<div class="panel-body" id="sunday_div" style="display:none">
		<?php  if(is_array($sundayset)) { foreach($sundayset as $item_Sun) { ?>
		<div class="form-group line_boxsss">
			<input type="hidden" name="sunday[id][]" value="<?php  echo $item_Sun['id'];?>">
			<div class="input-group clocknews">
				<div class="input-group clockpicker clocknew">
					<span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
			...
			<div class="col-sm-2 col-lg-2 frisset">
				<select name="sunday[out_in][]">
					<option value="">方向</option>
					<option value="1" <?php  if($item_Sun['out_in'] == 1) { ?>selected="selected"<?php  } ?>>进</option>
					<option value="2" <?php  if($item_Sun['out_in'] == 2) { ?>selected="selected"<?php  } ?>>出</option>
				</select>
			</div>
			<div class="col-sm-2 col-lg-2">
				<a href="javascript:;" class="custom-url-del delteclassicon" data-id="<?php  echo $item_Sun['id'];?>"><i class="fa fa-times-circle"></i></a>
				<select name="sunday[s_type][]">
					<option value="">选择学生</option>
					<option value="1" <?php  if($item_Sun['s_type'] == 1) { ?>selected="selected"<?php  } ?>>走读生</option>
					<option value="2" <?php  if($item_Sun['s_type'] == 2) { ?>selected="selected"<?php  } ?>>住校生</option>
					<option value="3" <?php  if($item_Sun['s_type'] == 3) { ?>selected="selected"<?php  } ?>>半通生</option>
				</select>
			</div>
		</div>
		<?php  } } ?>
