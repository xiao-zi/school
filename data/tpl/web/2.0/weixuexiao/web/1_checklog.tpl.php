				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-2 col-lg-2">
						<select style="margin-right:15px;" name="am_pm" class="form-control">
							<option value="0" <?php  if($_GPC['am_pm'] == 0 ) { ?> selected="selected"<?php  } ?>>按上下午搜索</option>
							<option value="1" <?php  if($_GPC['am_pm'] == 1 ) { ?> selected="selected"<?php  } ?>>上午</option>
							<option value="2" <?php  if($_GPC['am_pm'] == 2 ) { ?> selected="selected"<?php  } ?>>下午</option>
							...
							<tr>
								...
								<td> 
									<span class="label label-success">
										<?php  if($item['cardtype'] ==2) { ?>班级卡<?php  } ?>
								...
								<?php  if(is_showpf()) { ?>
								<td>
									<?php  if(!empty($item['createtime'])) { ?>
										<?php  if(date("a",$item['createtime']) == 'am') { ?>
										<span class="label label-info">上午</span>
										<?php  } else if(date("a",$item['createtime']) == 'pm') { ?>
								...
								<?php  if(is_TestFz()) { ?>
								<td>
									<?php  if(!empty($item['bet'])) { ?><?php  echo $item['bet'];?><?php  } ?>
								</td>
								<?php  } ?>
