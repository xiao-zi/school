...
<div class="panel panel-info">
    <div class="panel-heading"><a class="btn btn-primary" onclick="javascript :history.back(-1);"><i class="fa fa-tasks"></i> 返回新闻列表</a></div>
</div>
<div class="clearfix">
...
<div class="panel panel-info">
	...
	<div class="panel-body">
            <div class="form-group">
                <a class="btn btn-primary btn-sm qx_1412" href="<?php  echo $this->createWebUrl('news', array('op' => 'post', 'schoolid' => $schoolid))?>">添加新闻</a>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right; position:relative;">
						<a class="bj" href="<?php  echo $this->createWebUrl('news', array('op' => 'post', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="编辑">编辑</a>&nbsp;-&nbsp;
						<a class="qx_1413" onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('news', array('op' => 'delete', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="删除">删除</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
...
<script type="text/javascript">
	$(function(){
		<?php  if(!(IsHasQx($tid_global,1001412,1,$schoolid))) { ?>
			$(".qx_1412").hide();
			$(".bj").attr("title","查看");
			$(".bj").html("查看");
			$("#Layer2").show();
		...
		<?php  } ?>
		<?php  if(!(IsHasQx($tid_global,1001413,1,$schoolid))) { ?>
			$(".qx_1413").hide();
		<?php  } ?>
