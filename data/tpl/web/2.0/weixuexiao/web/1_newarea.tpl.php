...
<ul class="nav nav-tabs">
	<li <?php  if($_GPC['do'] == 'newcity') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('newcity', array('op' => 'display'))?>">城市管理</a></li>
	<li <?php  if($_GPC['do'] == 'newarea') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('newarea', array('op' => 'display'))?>">区域管理</a></li>
</ul>
 <style>
...
<a class="btn btn-primary" href="<?php  echo $this->createWebUrl('newarea', array('op' => 'display'))?>"><i class="fa fa-tasks"></i> 返回区域列表</a>
<div class="main">
...
<div class="main">
    <div class="panel panel-default">
        <div class="panel-body">
		    <a class="btn btn-primary" href="<?php  echo $this->createWebUrl('newarea', array('op' => 'post'))?>"><i class="fa fa-plus"></i> 添加区域</a>
