				...
				<div id="custom-url">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 col-lg-2">
							<input type="text" name="ssort" placeholder="排序" class="form-control" value="<?php  echo $coursetype['ssort'];?>" />
						</div>
						...
						<div class="col-sm-2 col-lg-2" style="width:30%">
							<input type="text" name="cTypeName" placeholder="课程类型" class="form-control" value="<?php  echo $coursetype['sname'];?>" />
						</div>
					</div>
					<?php  } else { ?>
