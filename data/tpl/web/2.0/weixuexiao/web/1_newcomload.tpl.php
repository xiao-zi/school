			...
			<div class="panel-heading">	
				<div class="row-fluid">
					<div class="span8 control-group">
						<a class="btn btn-default" href="<?php  echo $this->createWebUrl('newcomload', array('op' => 'display' ))?>"><i class="fa fa-search"></i>加载提示列表</a>
						<a class="btn <?php  if($operation == 'post') { ?>btn-primary <?php  } else { ?>btn-default"<?php  } ?> href="<?php  echo $this->createWebUrl('newcomload', array('op' => 'post' ))?>"><i class="fa fa-edit"></i>加载提示</a>
					</div>
				</div>
			</div>
	...
	<div class="panel panel-default">
		...
		<?php  } ?>	
            <div class="row" style="margin-left: 15px;">
                <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('public/new_ctrl_nave', TEMPLATE_INCLUDEPATH)) : (include template('public/new_ctrl_nave', TEMPLATE_INCLUDEPATH));?>
            </div>	
            <h3>公共加载 列表</h3>
			<div class="panel-heading">	
				<div class="row-fluid">
					<div class="span8 control-group">
						<a class="btn <?php  if($operation == 'post') { ?>btn-primary <?php  } else { ?>btn-default"<?php  } ?> href="<?php  echo $this->createWebUrl('newcomload', array('op' => 'post' ))?>"><i class="fa fa-edit"></i>添加公共加载</a>
					</div>
				</div>
			</div>
						...
						<?php  if(is_array($list)) { foreach($list as $banner) { ?>
							<tr>
								...
								<td style="text-align:left;">
									<a href="<?php  echo $this->createWebUrl('newcomload', array('op' => 'post', 'id' => $banner['id']))?>" data-toggle="tooltip" data-placement="top"  class="btn btn-default btn-sm manage"><i class="fa fa-edit"></i>修改</a>
									<a href="<?php  echo $this->createWebUrl('newcomload', array('op' => 'delete', 'id' => $banner['id']))?>" data-toggle="tooltip" data-placement="top"  class="btn btn-default btn-sm manage"><i class="fa fa-del"></i>删除</a> 
								</td>
							</tr>
						<?php  } } ?>
