        ...
        <div class="panel-body">
			<div id="queue-setting-index-body">
				<div class="alert alert-success">
					建议：当学校开启相关应用权限后，不要再次关闭学校使用该应用权限，如：学校启用团购功能，那么关闭后，学校已经创建的团购功能仍然能正常使用，但是学校无法创新新的团购课程
				</div>
						...
						<div class="apps_box">
							...
							<div class="apps_item_info">
								<div class="apps_item_name">
									推广员
									<span class="yaz" data-toggle="tooltip" data-placement="top" data-original-title="优质应用"></span>
									<?php  if($check_app['tuiguang'] == 1) { ?>
										<a class="apps_infos" style="color: #13ad13;">已安装</a>
									<?php  } else { ?>
										<a class="apps_infos" style="color: red;" data-toggle="tooltip" data-placement="top" data-original-title="请联系管理员">未安装</a>
									<?php  } ?>
								</div>
