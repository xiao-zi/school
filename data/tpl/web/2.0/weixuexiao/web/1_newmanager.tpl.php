    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                <a class="btn btn-success btn-sm" href="<?php  echo $this->createWebUrl('newmanger', array('op' => 'display', 'storeid' => $storeid, 'type' => 'qrcode'))?>"><i class="fa fa-qrcode"></i> 二维码</a>
                <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('newmanger', array('op' => 'post'))?>">创建二维码</a>
                <div class="form-group inline-form" style="display: inline-block;">
                    <form accept-charset="UTF-8" action="./index.php" class="form-inline" id="diandanbao/table_search" method="get" role="form">
                        ...
                        <input type="hidden" name="do" value="newmanger" />
                        <div class="form-group">
					...
					<?php  if(is_array($list)) { foreach($list as $item) { ?>
						<div class="qr-code-item">
							<div class="qr-code-op">
								<a data-rel="tooltip" href="<?php  echo $this->createWebUrl('newmanger', array('id' => $item['id'], 'op' => 'post'))?>" title="更新"><icon class="fa fa-edit"></icon></a>
								<a data-confirm="确定删除?" data-method="delete" data-rel="tooltip" href="<?php  echo $this->createWebUrl('newmanger', array('id' => $item['id'], 'op' => 'delete', 'gpid' => $item['gpid']))?>" onclick="return confirm('确认操作吗？');return false;" rel="nofollow" title="删除"><icon class="fa fa-trash-o"></icon></a>
							</div>
							<a href="#">
