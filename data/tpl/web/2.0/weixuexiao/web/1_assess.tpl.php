        ...
        <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<?php  if(is_TestFz()) { ?>
					<a class="btn btn-info qx_609" href="<?php  echo $this->createWebUrl('grade', array('op' => 'display', 'schoolid' => $schoolid))?>">查看教师评分</a>
					<?php  } ?>
    ...
    <div class="panel panel-default file-container" style="display:none;">
        <div class="panel-body">
            <form id="form">
                ...
                <a class="btn btn-info" href="../addons/weixuexiao/public/example/example_assess.xls"><i class="fa fa-download"></i>下载导入模板</a>
            </form>
        </div>
    </div>
		...
		<div class="panel panel-default">
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label  class="radio-inline"><input type="radio" name="is_show" value="1"  <?php  if(empty($item) || $item['is_show'] == 1) { ?>checked="true"<?php  } ?> /> 否</label>
                        &nbsp;&nbsp;&nbsp;
                        <label  class="radio-inline"><input type="radio" name="is_show" value="0"   <?php  if(!empty($item) && $item['is_show'] == 0) { ?>checked="true"<?php  } ?> /> 是</label>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline"><input type="radio" name="sex" value="1"  <?php  if(empty($item) || $item['sex'] == 1) { ?>checked="true"<?php  } ?> /> 男</label>
                        &nbsp;&nbsp;&nbsp;
                        <label  class="radio-inline"><input type="radio" name="sex" value="0" <?php  if(!empty($item) && $item['sex'] == 0) { ?>checked="true"<?php  } ?> /> 女</label>
                        <span class="help-block"></span>
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<label class="radio-inline"><input type="radio" name="is_sell" value="0"  <?php  if(empty($item) || $item['is_sell'] == 0) { ?>checked="true"<?php  } ?> />不参与销售</label>
						&nbsp;&nbsp;&nbsp;
						<label  class="radio-inline"><input type="radio" name="is_sell" value="1" <?php  if($item['is_sell'] == 1) { ?>checked="true"<?php  } ?> /> 经纪人</label>
						&nbsp;&nbsp;&nbsp;
						<label  class="radio-inline"><input type="radio" name="is_sell" value="2" <?php  if($item['is_sell'] == 2) { ?>checked="true"<?php  } ?> /> 教务</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<input type="text" name="plate_num" class="form-control" value="<?php  echo $item['plate_num'];?>" />
						</div>
					</div>
				</div>
				<?php  } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<label class="radio-inline"><input type="radio" name="status" value="2"  <?php  if(!empty($item) && $item['status'] == 2) { ?>checked="true"<?php  } ?> <?php  if(!empty($item) && is_njzr($item['id']) != 0) { ?> disabled <?php  } ?> /> 是</label>
						&nbsp;&nbsp;&nbsp;
						<label class="radio-inline"><input type="radio" name="status" value="1"   <?php  if(empty($item) || $item['status'] == 1) { ?>checked="true"<?php  } ?>  <?php  if(!empty($item) && is_njzr($item['id']) != 0) { ?> disabled <?php  } ?>/> 否</label>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<a class="btn btn-primary"  onclick="toggleteach();"><i id="teach_arrow" class="fa fa-caret-down"></i> 录入教学信息</a>
				</div>
			</div>             
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<a class="btn btn-primary"  onclick="toggledatail();"><i class="fa fa-caret-down" id="detail_arrow"></i> 录入详细信息</a>
				</div>
			</div>
...
<!--教师新增授课信息-->
<script>
function toggledatail(){
	$('#detail_info').slideToggle();
	$("#detail_arrow").toggleClass("fa-caret-up fa-caret-down");
}

function toggleteach(){
    $('#teach_info').slideToggle()
    $("#teach_arrow").toggleClass("fa-caret-up fa-caret-down");
}
...
$(document).ready(function() {
	...
	<?php  if(!(IsHasQx($tid_global,1000609,1,$schoolid))) { ?>
		$(".qx_609").hide();
	<?php  } ?>
	if(e_d == 0){
		$(".qx_e_d").hide();
	...
	$("#xq_id3").change(function() {
        let type = 3;
        let cityId = $("#xq_id3 option:selected").attr('value');
        changeGrade(cityId,type, function() {
		});
	});	
	$("#xq").change(function() {
