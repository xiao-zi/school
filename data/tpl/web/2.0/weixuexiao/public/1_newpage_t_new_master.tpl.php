...
<body>	
	...
	<div class="stuBox" style="background-color: rgb(23,128,42);padding:0">
        ...
        <div class="TripleIconDiv" id="TopIconDiv">
            ...
            <div  id="TopIconLo_1"  style="height:90px;width:30vw;position: relative;">
                <?php  if(!empty($TopIconFMaster['0'])) { ?>
                <div id="TiconD<?php  echo $TopIconFMaster[0]['id'];?>" data-setid="<?php  echo $TopIconFMaster[0]['id'];?>" class="linkBox TopLine-card HasDataCard" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;text-align: center;">
                        <img alt="" src="<?php  echo $TopIconFMaster[0]['icon'];?>" style="width:40px;">
                    </div>
                    <span class="linkName" data-inp-id="<?php  echo $TopIconFMaster[0]['id'];?> style="    color: #999; padding-top: 10px; font-size: 14px;text-align: center"><?php  echo $TopIconFMaster[0]['name'];?></span>	
                    <input type="hidden" class="card-id" name="TopIconId[1]" value="<?php  echo $TopIconFMaster[0]['id'];?>" style="height:auto;display:none">
                    <input type="hidden" class="card-id" name="TopIconIdorder[1]" value="1" style="height:auto;display:none">
                    
                    <div class="card-remove_top"><i class="material-icons fa fa-bars"  onclick="showMoFang(<?php  echo $TopIconFMaster[0]['id'];?>,this)"></i></div>
                </div> 
                <?php  } else { ?>
            ...
            <div  id="TopIconLo_2" style="height:90px;width:30vw;position: relative;">
                <?php  if(!empty($TopIconFMaster['1'])) { ?>
                <div id="TiconD<?php  echo $TopIconFMaster[1]['id'];?>" data-setid="<?php  echo $TopIconFMaster[1]['id'];?>" class="linkBox TopLine-card HasDataCard" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;text-align: center;">
                        <img alt="" src="<?php  echo $TopIconFMaster[1]['icon'];?>" style="width:40px;">
                    </div>
                    <span class="linkName" data-inp-id="<?php  echo $TopIconFMaster[1]['id'];?> style="    color: #999; padding-top: 10px; font-size: 14px;text-align: center"><?php  echo $TopIconFMaster[1]['name'];?></span>	
                    <input type="hidden" class="card-id" name="TopIconId[2]" value="<?php  echo $TopIconFMaster[1]['id'];?>" style="height:auto;display:none">
                    <input type="hidden" class="card-id" name="TopIconIdorder[2]" value="2" style="height:auto;display:none">
                    <div class="card-remove_top"><i class="material-icons fa fa-bars"  onclick="showMoFang(<?php  echo $TopIconFMaster[1]['id'];?>,this)"></i></div>
                </div> 
                <?php  } else { ?>
                <div class="linkBox TopLine-card" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;    text-align: center;">
            ...
            <div  id="TopIconLo_3" style="height:90px;width:30vw;position: relative;">
                <?php  if(!empty($TopIconFMaster['2'])) { ?>
                <div id="TiconD<?php  echo $TopIconFMaster[2]['id'];?>" data-setid="<?php  echo $TopIconFMaster[2]['id'];?>" class="linkBox TopLine-card HasDataCard" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;text-align: center;">
                        <img alt="" src="<?php  echo $TopIconFMaster[2]['icon'];?>" style="width:40px;">
                    </div>
                    <span class="linkName" data-inp-id="<?php  echo $TopIconFMaster[2]['id'];?> style="    color: #999; padding-top: 10px; font-size: 14px;text-align: center"><?php  echo $TopIconFMaster[2]['name'];?></span>	
                    <input type="hidden" class="card-id" name="TopIconId[3]" value="<?php  echo $TopIconFMaster[2]['id'];?>" style="height:auto;display:none">
                    <input type="hidden" class="card-id" name="TopIconIdorder[3]" value="3" style="height:auto;display:none">
                    <div class="card-remove_top"><i class="material-icons fa fa-bars"  onclick="showMoFang(<?php  echo $TopIconFMaster[2]['id'];?>,this)"></i></div>
                </div> 
                <?php  } else { ?>
                <div class="linkBox TopLine-card" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;    text-align: center;">
            ...
            <div  id="TopIconLo_4" style="height:90px;width:30vw;position: relative;">
                <?php  if(!empty($TopIconFMaster['3'])) { ?>
                <div id="TiconD<?php  echo $TopIconFMaster[3]['id'];?>" data-setid="<?php  echo $TopIconFMaster[3]['id'];?>" class="linkBox TopLine-card HasDataCard" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;text-align: center;">
                        <img alt="" src="<?php  echo $TopIconFMaster[3]['icon'];?>" style="width:40px;">
                    </div>
                    <span class="linkName" data-inp-id="<?php  echo $TopIconFMaster[3]['id'];?>" style="    color: #999; padding-top: 10px; font-size: 14px;text-align: center"><?php  echo $TopIconFMaster[3]['name'];?></span>	
                    <input type="hidden" class="card-id" name="TopIconId[4]" value="<?php  echo $TopIconFMaster[3]['id'];?>" style="height:auto;display:none">
                    <input type="hidden" class="card-id" name="TopIconIdorder[4]" value="4" style="height:auto;display:none">
                    <div class="card-remove_top"><i class="material-icons fa fa-bars"  onclick="showMoFang(<?php  echo $TopIconFMaster[3]['id'];?>,this)"></i></div>
                </div> 
                <?php  } else { ?>
                <div class="linkBox TopLine-card" style="width:100%;padding: 16px 0 10px 0;text-align: center ">
                    <div class="linkImg" style="height: 45px;    text-align: center;">
        ...
        <div class="linkDiv grid" id="linkDiv" style="margin-left: 1%; margin-right: 1%;;margin-top:10px;">
            ...
            $is_top  = 0 ;
            if(in_array($row['id'],$TeaArrayMaster)){
                $is_top = 1;
            }
