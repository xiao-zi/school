...
<body>	
    ...
    <div class="linkDiv grid" id="linkDiv" style="margin-top:10px;">
        <?php  if(is_array($iconsF)) { foreach($iconsF as $key => $row) { ?>	
          <div class="item  w1 red muuri-item muuri-item-shown linkBox" data-id="<?php  echo $row['ssort'];?>" data-color="red" data-title="mk" style="left: 0px; top: 0px; transform: translateX(240px) translateY(0px); display: block; touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
              <div class="item-content " style="opacity: 1; transform: scale(1);">
                <div class="card " style="height:auto">
                    ...
                    <span class="linkName"><?php  if($row['icontype']) { ?>(<?php  echo $row['icontype'];?>)<?php  } else { ?>更多功能<?php  } ?></span>	 
