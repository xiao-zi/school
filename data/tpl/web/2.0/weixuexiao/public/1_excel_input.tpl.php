<?php defined('IN_IA') or exit('Access Denied');?>	<div class="modal fade" style="min-width: 583px!important;" id="Modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
    ...
    <script type="text/javascript">
		...
		function gopress(count,datas,type) {
			...
			var pointicon = "<?php echo OSSURL;?>public/mobile/img/arrow_right.png";
			...
			for (var i=2;i<count+2;i++){
				$.ajax({
					...
					data: {
						...
						line:i,
						tid_global : "<?php  echo $tid_global;?>"
					},
