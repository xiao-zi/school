...
<?php  if(is_array($xsqj)) { foreach($xsqj as $row) { ?>
	<section id="titlebar_bg" class="vacationRecord_section" <?php  if($row['key'] ==1) { ?>style="margin-top:70px;"<?php  } ?>>
		...
		<?php  if(is_showpf()) { ?>
		<div class="vacationItem">
			<span class="vacation_time">时间类型:</span><span class="vacation_time vacation_left"><?php  if($row['more_less'] == 1) { ?>一天内<?php  } else if($row['more_less'] == 2) { ?>一天以上<?php  } ?></span>
			<div class="left_dotsVacation"></div>
		</div>

		<?php  if($row['more_less'] == 1) { ?>
		<div class="vacationItem">
			<span class="vacation_time">请假节数:</span><span class="vacation_time vacation_left"><?php  echo $row['ksnum'];?>节</span>
			<div class="left_dotsVacation"></div>
		</div>
		<div class="vacationItem">
		...
		<?php  } else { ?>
		<div class="vacationItem">
			<span class="vacation_time">开始日期:</span><span class="vacation_time vacation_left"><?php  if($row['startime']) { ?><?php  echo $row['startime'];?><?php  } else { ?><?php  echo date('Y-m-d',$row['startime1'])?><?php  } ?></span>
			<div class="left_dotsVacation"></div>
		</div>
		<div class="vacationItem">
			<span class="vacation_time">结束日期:</span><span class="vacation_time vacation_left"><?php  if($row['endtime']) { ?><?php  echo $row['endtime'];?><?php  } else { ?><?php  echo date('Y-m-d',$row['endtime1'])?><?php  } ?></span>
			<div class="left_dotsVacation"></div>
		</div>
		<?php  } ?>
