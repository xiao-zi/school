    ...
    <div id="wrap" class="user_order"   >
        ...
        <header id="header"  >
            <ul class="order">
                ...
                <li class="order_li no_g" ><a  style="color: inherit !important;" href="javascript:void(0)" <?php  if($rest != 0) { ?>value = "<?php  echo $rest;?>"<?php  } ?> id="no_g">待支付</a></li>
		...
		<div class="clear" style="height:5px;"></div>
            ...
            <?php  if(!empty($list)) { ?>
				...
				<div class="c-comment-list" style="border: 0;">
					<a class="o-con" href="<?php  echo $this->createMobileUrl('editorder',array('orderid'=>$item['ddid'],'goodsid'=>$item['goodsid'],'morderid'=>$item['id'],'schoolid'=>$schoolid,'op'=>'showorder','weid' => $weid ))?>">
				...
				<?php  if($item['status'] == 1 ) { ?>
					<a href="<?php  echo $this->createMobileUrl('mallpay',array('orderid'=>$item['ddid'],'morderid'=>$item['id'],'schoolid'=>$schoolid,'op'=>'mallpay','weid' => $weid ))?>">立即支付</a>
...
$(function() { 
	...
	$('#jiesuan').bind('click', function() {
		...
		window.location.href = "<?php  echo $this->createMobileUrl('gopay', array('schoolid' => $schoolid),true)?>" + "&str=" + str + "&dos=getorder";
	});
});
