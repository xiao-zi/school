...
<div class="all">
		...
		<div class="msgBox">
			<div class="campusBox">
				...
				<span class="c"><?php  echo $teacher['tname'];?></span>
			</div>
			<?php  if(is_showpf()) { ?>
			<div class="campusBox">
				<span class="l">联系电话：</span>
				<span class="c"><?php  echo $teacher['mobile'];?></span>
			</div>
			<div class="timeBox">
				<span class="l">任教科目：</span>
				<span class="c">
					<select name="select" id="classid" >
						<?php  if(is_array($teacher_classlist)) { foreach($teacher_classlist as $row) { ?>
				         <option value="<?php  echo $row['id'];?>"><?php  echo $row['bj_name'];?> <?php  echo $row['km_name'];?></option>
						<?php  } } ?>
				     </select>
				</span>
			</div>
			...
			<div class="checkedBox">
				...
				<span class="c">                    
					<select name="select" id="totid" >
						...
						<?php  if(is_array($shlist)) { foreach($shlist as $row) { ?>
