...
<div id="titlebar" class="header mainColor">
	...
	<div class="m">
		<span style="font-size: 18px"><?php  if($school['bjqstyle'] =='new') { ?>发布班级圈<?php  } else { ?>发布校园动态<?php  } ?></span>   
	</div>
</div>    
...
<div class="feedback_box">
	...
	<div class="feedback_title_box">
        <select class="feedback_title" id="bj_id">
            ...
            <option value="-1" <?php  if($op == 'fxzy' && $row['bj_id'] == $bj_id) { ?> selected = "selected" <?php  } ?>>@全校</option>
            <?php  } ?>
...
<div class="add_link_box" <?php  if($op == 'fxzy' ) { ?> style="display: block;"<?php  } ?> style="top:0px">
    <div class="add_link_info_wrap">
        <div class="my_add_link_inner">
            ...
            <div class="add_link_wrap">
                <span class="my_link_title">链接地址：</span><input class="my_add_link_txt" type="text" id="link_address" <?php  if($op == 'fxzy' ) { ?> value="index.php?i=<?php  echo $weid;?>&c=entry&schoolid=<?php  echo $schoolid;?>&noticeid=<?php  echo $noticeid;?>&sid=<?php  echo $sid;?>&bj_id44=<?php  echo $bj_id;?>&do=showhomework&m=weixuexiao " readonly <?php  } ?>>
            </div>
