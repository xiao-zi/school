	        ...
	        <div class="inteCount1">
	            <div class="inteCount2">
	                <div class="inteCount3">
	                    <span><?php  echo $teacher['point'];?></span><br><span>积分</span>
	                </div>
	            </div>
	        </div>
	    </div>
...
<div class="wrapper">
	<ul class="wall">
		...
		<li class="article">
			<a href="<?php  echo $this->createMobileUrl('goodsdetail',array('schoolid' => $schoolid,'id' => $userid['id'],'goodsid' => $item['id']), true)?>">
...
<script type="text/javascript">
	function showCheckBox(){
		window.location.href = "<?php  echo $this->createMobileUrl('getorder', array('schoolid' => $schoolid,'weid'=>$weid,'op'=>'all_g'), true)?>"
};
</script>
