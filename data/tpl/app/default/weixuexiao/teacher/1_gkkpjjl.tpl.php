...
<div class="header mainColor">
	...
	<div class="m"><a><span style="font-size: 18px">我评价的公开课</span></a></div>
...
// 底部加载更多
	new Scroll_load({
		...
		"ajax_url": "<?php  echo $this->createMobileUrl('gkkpjjl', array('schoolid' => $schoolid, 'userid' => $it['id']), true)?>",
	   ...
	   strConvertHtml();
		...
		$('body').on('click',  '.main', function(e) {
			if (!$(e.target).parent().is('.notifyImgItem')) {
				...
				window.location.href = "<?php  echo $this->createMobileUrl('gkkpjshare', array('fenxiang'=>'jinru','schoolid' => $schoolid ,'userid'=>$it['id']))?>"+ '&gkkid=' + notifyUid;
			} 
		});
