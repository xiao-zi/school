    ...
    <div class="manual_main1">
        <div class="manual_visible_box">
            ...
            <div class="manual_main_box2">
                <div class="head_til"><p><span style="color:black !important;">公开课：<?php  echo $gkkinfo['name'];?></span> </p> </br><img src="<?php  if($teacher['thumb']) { ?><?php  echo tomedia($teacher['thumb'])?><?php  } else { ?><?php  echo tomedia($school['tpic'])?><?php  } ?>">&nbsp;授课教师：<?php  echo $teacher['tname'];?></p></div>
                    ...
                    <ul class="manual_baby_situation_ul">
                        <li>
                            ...
                            <div class="li_block">
                                ...
                                <div style="float:left;margin-bottom: unset;color:red;font-weight: bold">评价：</div><div class="situation_level1" style="float:left;margin-bottom: unset;background-image: url(<?php  echo tomedia($row['icon'])?>)"><?php  echo $row['icontitle'];?></div>
                            </div>
                        </li>
                    </ul>
                    <?php  } } ?>
