...
<div id="titlebar" class="header mainColor">
	...
	<div class="m"><a><span style="font-size: 18px">积分明细</span></a></div>
		...
		<li class="main" time="<?php  echo $item['createtime'];?>" id="<?php  echo $item['id'];?>" style="display: block;margin: 1px 10px 1px 10px;">
			...
			<div class="notifyTopBox">
				...
				<div class="notifyTopRight">
					...
					<?php  if($item['type'] == 2 ) { ?><p class="notifyTimeM">【任务】<?php  if($item['mcount'] == $item['max']) { ?><span class="notifyTimeF">【已完成】</span><?php  } ?></p>
...
// 底部加载更多
	new Scroll_load({
		...
		"ajax_url": "<?php  echo $this->createMobileUrl('pointdetail', array('schoolid' => $schoolid, 'bj_id' => $bj_id), true)?>",
		"page_name": "teacher_jf",
		"after_ajax": function () {
