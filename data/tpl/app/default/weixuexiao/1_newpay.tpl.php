...
<script type="text/javascript" src="<?php echo MODULE_URL;?>public/mobile/js/mui.js?v=3"></script>
<script type="text/javascript" src="<?php echo MODULE_URL;?>public/mobile/js/newutil.js?v=3"></script>
<script>
//课程页面的支付按钮
			...
			success:function(data){
				if(data.result){
					if(window.__wxjs_environment === 'miniprogram'){
						wx.miniProgram.navigateTo({url: '../payment/payment?orderid='+data.orderid+'&cose='+data.fee+'&nowweid=<?php  echo $weid;?>&schoolid=<?php  echo $schoolid;?>&do=sgetorder'})
					}else{
						var jumpurl = decodeURIComponent(data.jumpurl)
						var NowWeid = '<?php  echo $_W['uniacid'];?>';
