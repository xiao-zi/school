...
<head>
    ...
    font-style: normal
        ...
        .check_this{background:url(<?php echo MODULE_URL;?>public/mobile/img/be_choose_icon_02.png) right center;background-size:20px 15px;-moz-background-size:63px 100px; /* 老版本的 Firefox */background-repeat:no-repeat;size: 10px}
    ...
    <script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=<?php  echo $set['baidumapapi'];?>&s=1"></script>
...
<body>
                ...
                <div class="ddb-nav-pane ng-isolate-scope ng-hide">
                    <div class="sub-pane cur-sub-pane ng-scope ng-isolate-scope" >
                        <ul class="citytype ng-scope">
                            ...
                            <li class="sub-item ng-scope" data-id="<?php  echo $row['id'];?>" onclick="regetdata('cityid',<?php  echo $row['id'];?>,this);">
                                <div class="name ng-binding"><?php  echo $row['name'];?></div>
                            </li>
                            <?php  } } ?>
                        </ul>
                    </div>
                ...
                <div class="ddb-nav-pane ng-isolate-scope ng-hide">
                    <div class="sub-pane cur-sub-pane ng-scope ng-isolate-scope" >
                        <ul class="areatype ng-scope">
                            ...
                            <li class="sub-item ng-scope areali" parentid="<?php  echo $item['parentid'];?>"  onclick="regetdata('areaid',<?php  echo $item['id'];?>,this);">
                                <div class="name ng-binding"><?php  echo $item['name'];?></div>
                            </li>
                            <?php  } } ?>
                        </ul>
                    </div>
                ...
                <div class="ddb-nav-pane ng-isolate-scope ng-hide">
                    <div class="sub-pane cur-sub-pane ng-scope ng-isolate-scope">
                        <ul class="shoptype ng-scope">
                            ...
                            <li class="sub-item ng-scope" data-id="<?php  echo $item['id'];?>" onclick="regetdata('typeid',<?php  echo $item['id'];?>,this);">
                                <div class="name ng-binding"><?php  echo $item['name'];?></div>
                            </li>
                            <?php  } } ?>
                        </ul>
    ...
    <script language="javascript">
        ...
        Scroll_load.prototype.load_init = function () {
            ...
            $('body').append('<div class="has_show_over" style="clear:both;height:45px;line-height:45px"><div class="jzz_div"><div class="jzz jzz_over"><div class="pir"><img src="<?php echo MODULE_URL;?>public/mobile/img/p_jzz.png" /></div><div class="jzz_text"></div></div></div></div>');
