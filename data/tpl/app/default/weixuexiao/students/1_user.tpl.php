    ...
    <div id="wrap" class="user_list">
        ...
        <section class="user">
			...
			<?php  if($school['is_rest'] == 1) { ?>
				<a href="<?php  echo $this->createMobileUrl('sclistforxs', array('schoolid' => $schoolid,'userid' => $it['id']), true)?>" class="shouce"><?php  echo $school['shoucename'];?>11</a>
			<?php  } ?>
			<?php  if($school['is_video'] == 1) { ?>
				<a href="<?php  echo $this->createMobileUrl('allcamera', array('schoolid' => $schoolid,'userid'=>$it['id']), true)?>" class="jiankong"><?php  echo $school['videoname'];?>22</a>
			<?php  } ?>
			<a href="<?php  echo $this->createMobileUrl('allcamera', array('schoolid' => $schoolid,'userid'=>$it['id']), true)?>" class="jiankong"><?php  echo $school['videoname'];?>22</a>
		...
		<div class="single" style="z-index:100000;border-radius: 5%;">
			...
			<?php  if(is_array($user)) { foreach($user as $row) { ?>
				<li onclick="isSelect(<?php  echo $row['id'];?>,<?php  echo $row['schoolid'];?>);">
					<span class="le"><?php  echo $row['bjname'];?></span><span class="ri"><?php  echo $row['s_name'];?></span>
				</li>
			<?php  } } ?>
			</ul>
		</div>
