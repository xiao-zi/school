...
<div class="All" style="height: 100%;">
	<section>
	    <form id="frmAddress" action="<?php  echo $this->createMobileUrl('getorder',array('schoolid' => $schoolid,'id' => $userid), true)?>" method="POST">
	        ...
	        <!--商品信息-->
	        <div class="phone_number" style="font-weight:900"><?php  echo $language['seditorder_title'];?></div>
	        <div class="name">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".jia").click(function(){
			...
			var countpayd = <?php  echo $countall;?>;
			var xsxg = <?php  echo $xsxg;?>;
...
<?php  } ?>
 ...
 <div class="phone_number" > <ul class="head_title">
			...
			<li  id="jdwj" onclick="showaddress()"><?php  echo $language['seditorder_jdwj'];?></li>
			<li  id="dxzq" class="act" onclick="hideaddress()"><?php  echo $language['seditorder_dxzq'];?></li>
		</ul></div>
			<!--收货人信息-->
	...
	//弃用form提交，改用ajax提交
      //  $("#frmAddress").submit();
		  ...
		  var beizhu = $("#mark").val();
            ...
            $.post("<?php  echo $this->createMobileUrl('payajax',array('op'=>'mallorder'))?>",{"GoodId":GoodId, "GoodPoint":GoodPoint,"GoodPrice":GoodPrice, "NumOfGood":NumOfGood, "AddId":AddId,"schoolid":<?php  echo $schoolid;?>,"weid":<?php  echo $weid;?>,"qhtype":qhtype,"beizhu":beizhu,"tid":0,"sid":<?php  echo $it['sid'];?>,"userid":<?php  echo $userid;?>,'uid':<?php  echo $it['uid'];?>},function(data){
					if(data.result){
						jTips(data.info);
