...
.parent_notify{border-top:1px solid rgb(196, 196, 196) ;border-bottom:1px solid rgb(196, 196, 196) ;padding: 12px 0 12px 25px;background:url(<?php echo MODULE_URL;?>public/mobile/img/parent_notify_icon.png) no-repeat #fff;background-size:19px 15px;background-position:15px center;color:#999;margin-bottom: 10px;text-indent: 1em;}
...
.head .pdetail {height: 100px;padding: 15px 0 0 20px;-webkit-box-sizing: border-box;}
...
.head .head-nav .head-nav-list {display: inline-block;float: left;text-decoration: none;color: #FFF;width: 50%;text-align: center;font-size: 16px;background: -webkit-gradient(linear, 0 0, 0 100, from(rgba(255,255,255,0.5)), to(rgba(255,255,255,0.5)) ) no-repeat left center;-webkit-background-size: 1px 75%;padding-top:5px;font-size: 14px}
...
.pull-left{border-radius: 12px;width: 93%;height: 81px; }
...
.MyInfo{height: 26px;margin-top: 2px;padding:0 3px;border-radius: 15px;background-color: #ceb750;width:80px;float: right;position: absolute;top:60px;right: 0px;}
.font_icon{width: 15px;margin-top: 6px;margin-left: 7px;margin-right: 2px;}
...
.parent_option a:nth-child(n):after{ content: ""; width:1px; height:130px; background-color: #f0f0f2; position: absolute; right:0; top: 0; }
.parent_option a:nth-child(3n):after{ content:none; width:1px; height:130px; background-color: #f0f0f2; position: absolute; right:0; top: 0; }
...
<div class="pdetail">
	...
	<div class="tSign" id="Changesf">
		<div>切换</div>
	</div>
	<div  class="MyInfo" style="height: 26px" id="GRZX">
	<img class="font_icon"  src="<?php echo MODULE_URL;?>public/mobile/img/change_image.png"></img>  <div  style="line-height: 26px; float: right; margin-right: 4px;color:white;" >个人中心</div> 
	</div>
</div>
<div class="head-nav">
	<a class="head-nav-list"><span><?php  echo $language['user_bj'];?>:</span> <span style="margin-left: 10px"><?php  echo $mybanji['sname'];?></span> </a>
	<a class="head-nav-list"><span><?php  echo $language['user_xs'];?>:</span><span style="margin-left: 10px"><?php  echo $students['s_name'];?></span></a>
</div>
<?php  if($school['is_shoufei'] == 1) { ?>
<section class="user" style="margin-top: -35px;">
	<ul class="order" >
		<li style="border-radius: 30px 0 0 0;" class="order_li"><a href="<?php  echo $this->createMobileUrl('order', array('schoolid' => $schoolid, 'op' => 'all_g'), true)?>"><?php  echo $language['user_qb'];?></a></li>
		...
		<li style="border-radius: 0 30px 0 0;" class="order_li"><a href="<?php  echo $this->createMobileUrl('order', array('schoolid' => $schoolid, 'op' => 'cancel_g'), true)?>"><?php  echo $language['user_ytf'];?></a></li>
	</ul>
</section>
<?php  } ?>
</div>
...
<div class="parent_option">
	...
	<a <?php  if($row['salfcard']) { ?>onclick="salfcard(<?php  echo $it['sid'];?>)"<?php  } else { ?>href="<?php  echo $row['url'];?>"<?php  } ?> style="background-size: 38px 40px;background-position: 90% center;text-align: center ">
		...
		<span style="font-size: 14px;color:gray"><?php  echo $row['name'];?></span>
...
<script type="text/javascript">
	...
	$("#GRZX").on('click', function () {
       ...
       window.location.href = "<?php  echo $this->createMobileUrl('useredit', array('schoolid' => $schoolid), true)?>";
    });
