...
Scroll_load.prototype.load_init = function () {
    ...
    if ($('.has_show_over').length == 0) {
        $(self.ul_box).after('<div class="has_show_over" style="clear:both;height:45px;line-height:45px;display: none"><div class="jzz_div"><div class="jzz jzz_over"><div class="pir"><img src="https://weimeizhanoss.oss-cn-shenzhen.aliyuncs.com/public/mobile/img/p_jzz.png" /></div><div class="jzz_text"></div></div></div></div>');
    }
