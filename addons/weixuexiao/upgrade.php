...
if(!pdo_fieldexists('wx_school_allcamera','startime2')) {pdo_query("ALTER TABLE ".tablename('wx_school_allcamera')." ADD   `startime2` varchar(50) NOT NULL");}
if(!pdo_fieldexists('wx_school_allcamera','startime3')) {pdo_query("ALTER TABLE ".tablename('wx_school_allcamera')." ADD   `startime3` varchar(50) NOT NULL");}
...
if(!pdo_fieldexists('wx_school_area','createtime')) {pdo_query("ALTER TABLE ".tablename('wx_school_area')." ADD   `createtime` int(10) unsigned NOT NULL");}
...
if(!pdo_fieldexists('wx_school_bjq','www')) {pdo_query("ALTER TABLE ".tablename('wx_school_bjq')." ADD   `www` varchar(30) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('wx_school_bjq','wq')) {pdo_query("ALTER TABLE ".tablename('wx_school_bjq')." ADD   `wq` varchar(30) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('wx_school_checklog','qdtid')) {pdo_query("ALTER TABLE ".tablename('wx_school_checklog')." ADD   `qdtid` int(11) NOT NULL COMMENT '代签userid'");}
...
if(!pdo_fieldexists('wx_school_classify','videostart')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `videostart` varchar(50) NOT NULL DEFAULT ''");}
if(!pdo_fieldexists('wx_school_classify','videoend')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `videoend` varchar(50) NOT NULL DEFAULT ''");}
if(!pdo_fieldexists('wx_school_classify','cost')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `cost` varchar(50) NOT NULL DEFAULT ''");}
...
if(!pdo_fieldexists('wx_school_classify','pname')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `pname` varchar(50) NOT NULL DEFAULT '' COMMENT '称谓'");}
if(!pdo_fieldexists('wx_school_classify','carmeraid')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `carmeraid` text COMMENT '说明'");}
if(!pdo_fieldexists('wx_school_classify','videoclick')) {pdo_query("ALTER TABLE ".tablename('wx_school_classify')." ADD   `videoclick` int(11) unsigned NOT NULL COMMENT '视频点击量'");}
...
if(!pdo_fieldexists('wx_school_dianzan','aitewo')) {pdo_query("ALTER TABLE ".tablename('wx_school_dianzan')." ADD   `aitewo` varchar(30) NOT NULL DEFAULT '0' COMMENT '图片路径'");}
if(!pdo_fieldexists('wx_school_dianzan','0953')) {pdo_query("ALTER TABLE ".tablename('wx_school_dianzan')." ADD   `0953` varchar(30) NOT NULL DEFAULT '0' COMMENT '图片路径'");}
...
if(!pdo_fieldexists('wx_school_hothit','btnid')) {pdo_query("ALTER TABLE ".tablename('wx_school_hothit')." ADD   `btnid` int(10) unsigned NOT NULL");}
if(!pdo_fieldexists('wx_school_hothit','formid_use')) {pdo_query("ALTER TABLE ".tablename('wx_school_hothit')." ADD   `formid_use` int(10) unsigned NOT NULL");}
...
if(!pdo_fieldexists('wx_school_index','logo')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `logo` varchar(200) NOT NULL DEFAULT '' COMMENT '学校logo'");}
...
if(!pdo_fieldexists('wx_school_index','0953')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `0953` varchar(30) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('wx_school_index','isopen')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `isopen` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0显示1否'");}
...
if(!pdo_fieldexists('wx_school_index','manger')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `manger` varchar(200) NOT NULL DEFAULT '' COMMENT '信息审核员'");}
...
if(!pdo_fieldexists('wx_school_index','lxend2')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `lxend2` varchar(50) DEFAULT ''");}
...
if(!pdo_fieldexists('wx_school_index','is_showew')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `is_showew` tinyint(1) NOT NULL DEFAULT '1' COMMENT '2显示1否'");}
if(!pdo_fieldexists('wx_school_index','is_zjh')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `is_zjh` tinyint(1) NOT NULL DEFAULT '1' COMMENT '2显示1否'");}
if(!pdo_fieldexists('wx_school_index','is_showad')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `is_showad` int(10) NOT NULL DEFAULT '0' COMMENT '广告ID'");}
...
if(!pdo_fieldexists('wx_school_index','userstyle')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `userstyle` varchar(50) NOT NULL DEFAULT 'user' COMMENT '家长学生中心模板'");}
if(!pdo_fieldexists('wx_school_index','bjqstyle')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `bjqstyle` varchar(50) NOT NULL DEFAULT 'old'");}
...
if(!pdo_fieldexists('wx_school_index','mallsetinfo')) {pdo_query("ALTER TABLE ".tablename('wx_school_index')." ADD   `mallsetinfo` varchar(500) NOT NULL");}
...
if(!pdo_fieldexists('wx_school_kcbiao','isxiangqing')) {pdo_query("ALTER TABLE ".tablename('wx_school_kcbiao')." ADD   `isxiangqing` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0显示1否'");}
...
if(!pdo_fieldexists('wx_school_leave','isfrist')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `isfrist` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1是0否'");}
if(!pdo_fieldexists('wx_school_leave','is_on')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `is_on` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1启用2不启用'");}
if(!pdo_fieldexists('wx_school_leave','banner')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `banner` varchar(2000) DEFAULT ''");}
if(!pdo_fieldexists('wx_school_leave','userid')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `userid` int(11) DEFAULT NULL");}
if(!pdo_fieldexists('wx_school_leave','touserid')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `touserid` int(11) DEFAULT NULL");}
if(!pdo_fieldexists('wx_school_leave','isread')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `isread` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1是2否'");}
if(!pdo_fieldexists('wx_school_leave','startime1')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `startime1` int(10) DEFAULT NULL");}
if(!pdo_fieldexists('wx_school_leave','endtime1')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `endtime1` int(10) DEFAULT NULL");}
...
if(!pdo_fieldexists('wx_school_leave','reconet')) {pdo_query("ALTER TABLE ".tablename('wx_school_leave')." ADD   `reconet` varchar(200) DEFAULT '' COMMENT '教师回复'");}
...
if(!pdo_fieldexists('wx_school_media','type')) {pdo_query("ALTER TABLE ".tablename('wx_school_media')." ADD   `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0班级圈1相册'");}
...
if(!pdo_fieldexists('wx_school_media','isfm')) {pdo_query("ALTER TABLE ".tablename('wx_school_media')." ADD   `isfm` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0否1是'");}
...
if(!pdo_fieldexists('wx_school_notice','picarr')) {pdo_query("ALTER TABLE ".tablename('wx_school_notice')." ADD   `picarr` text COMMENT '用户信息'");}
...
if(!pdo_fieldexists('wx_school_notice','ismobile')) {pdo_query("ALTER TABLE ".tablename('wx_school_notice')." ADD   `ismobile` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0手机1电脑'");}
...
if(!pdo_fieldexists('wx_school_order','sid')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `sid` int(10) unsigned NOT NULL COMMENT '所属图文id'");}
...
if(!pdo_fieldexists('wx_school_order','obid')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `obid` int(10) unsigned NOT NULL COMMENT '项目ID'");}
...
if(!pdo_fieldexists('wx_school_order','status')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1未支付2为未支付3为已退款'");}
if(!pdo_fieldexists('wx_school_order','type')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1课程2项目3功能'");}
...
if(!pdo_fieldexists('wx_school_order','aitewo')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `aitewo` varchar(30) NOT NULL DEFAULT '0' COMMENT '支付LOGO'");}
if(!pdo_fieldexists('wx_school_order','0953')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `0953` varchar(30) NOT NULL DEFAULT '0' COMMENT '支付LOGO'");}
...
if(!pdo_fieldexists('wx_school_order','tuitime')) {pdo_query("ALTER TABLE ".tablename('wx_school_order')." ADD   `tuitime` int(10) unsigned NOT NULL COMMENT '退款时间'");}
...
if(!pdo_fieldexists('wx_school_set','bjqshjg')) {pdo_query("ALTER TABLE ".tablename('wx_school_set')." ADD   `bjqshjg` varchar(200) DEFAULT ''");}
if(!pdo_fieldexists('wx_school_set','bjqshtz')) {pdo_query("ALTER TABLE ".tablename('wx_school_set')." ADD   `bjqshtz` varchar(200) DEFAULT ''");}
...
if(!pdo_fieldexists('wx_school_set','jxtx')) {pdo_query("ALTER TABLE ".tablename('wx_school_set')." ADD   `jxtx` varchar(200) DEFAULT '' COMMENT '进校提醒'");}
...
if(!pdo_fieldexists('wx_school_set','stutemplate')) {pdo_query("ALTER TABLE ".tablename('wx_school_set')." ADD   `stutemplate` varchar(10) NOT NULL");}
...
if(!pdo_fieldexists('wx_school_signup','cost')) {pdo_query("ALTER TABLE ".tablename('wx_school_signup')." ADD   `cost` varchar(10) NOT NULL");}
...
if(!pdo_fieldexists('wx_school_sms_log','msg')) {pdo_query("ALTER TABLE ".tablename('wx_school_sms_log')." ADD   `msg` varchar(1000) NOT NULL COMMENT '返回消息'");}
if(!pdo_fieldexists('wx_school_sms_log','status')) {pdo_query("ALTER TABLE ".tablename('wx_school_sms_log')." ADD   `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '默认成功1'");}
...
if(!pdo_fieldexists('wx_school_students','wq')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `wq` varchar(30) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('wx_school_students','icon')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `icon` varchar(255) DEFAULT '' COMMENT '头像'");}
if(!pdo_fieldexists('wx_school_students','ouserid')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `ouserid` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('wx_school_students','muserid')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `muserid` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('wx_school_students','duserid')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `duserid` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('wx_school_students','otheruserid')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `otheruserid` int(11) unsigned NOT NULL");}
if(!pdo_fieldexists('wx_school_students','other')) {pdo_query("ALTER TABLE ".tablename('wx_school_students')." ADD   `other` varchar(30) DEFAULT '0' COMMENT '家长'");}
...
if(!pdo_fieldexists('wx_school_tcourse','ssort')) {pdo_query("ALTER TABLE ".tablename('wx_school_tcourse')." ADD   `ssort` tinyint(5) NOT NULL DEFAULT '0'");}
...
if(!pdo_fieldexists('wx_school_teachers','cc')) {pdo_query("ALTER TABLE ".tablename('wx_school_teachers')." ADD   `cc` varchar(30) NOT NULL DEFAULT '0' COMMENT '0'");}
...
if(!pdo_fieldexists('wx_school_teachers','openid')) {pdo_query("ALTER TABLE ".tablename('wx_school_teachers')." ADD   `openid` varchar(30) NOT NULL DEFAULT '0' COMMENT '老师微信'");}
...
if(!pdo_fieldexists('wx_school_teachers','fz_id')) {pdo_query("ALTER TABLE ".tablename('wx_school_teachers')." ADD   `fz_id` int(11) NOT NULL COMMENT '分组ID'");}
...
if(!pdo_fieldexists('wx_school_wxpay','id')) {pdo_query("ALTER TABLE ".tablename('wx_school_wxpay')." ADD 
  `id` int(10) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('wx_school_wxpay','aitewo')) {pdo_query("ALTER TABLE ".tablename('wx_school_wxpay')." ADD   `aitewo` varchar(30) NOT NULL DEFAULT '0' COMMENT '订单ID'");}
if(!pdo_fieldexists('wx_school_wxpay','0953')) {pdo_query("ALTER TABLE ".tablename('wx_school_wxpay')." ADD   `0953` varchar(30) NOT NULL DEFAULT '0' COMMENT '订单ID'");}
...
if(!pdo_fieldexists('wx_school_wxpay','openid')) {pdo_query("ALTER TABLE ".tablename('wx_school_wxpay')." ADD   `openid` varchar(30) NOT NULL DEFAULT '' COMMENT 'openid'");}
