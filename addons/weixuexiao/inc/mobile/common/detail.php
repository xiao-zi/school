 ...
 */
		...
		$banners = pdo_fetchall("SELECT id,arr,begintime,endtime,leixing,thumb,schoolid,bannername,link FROM " . tablename($this->table_banners) . " WHERE enabled = 1 AND weid = '{$_W['uniacid']}' ORDER BY leixing DESC, displayorder ASC");
		$barr = array();
