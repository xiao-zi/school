    ...
    if(!empty($ckmac)){
        ...
        $result['getBasic'] = array(
            array(
                ...
                'STU2' => $ckmac['stu2'],
                'STU3' => $ckmac['stu3'],
                'CHECK_URL'      => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&op=check&m=weixuexiao',
                'LEAVE_URL'      => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&op=getleave&m=weixuexiao',
                'OUTTIME_URL'    => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&op=timeset&m=weixuexiao',
                'BUSGPS' 		 => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&op=busgps&m=weixuexiao',
                'getroomlisturl' => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&op=getroomlist&m=weixuexiao',
