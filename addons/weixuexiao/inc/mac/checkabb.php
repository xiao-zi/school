    ...
    if(!empty($ckmac)){
        ...
        $result['data'] = array(
            array(
				...
				'online_url'  	  => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkabb&op=online&m=weixuexiao',
				'check_url'       => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkabb&op=check&m=weixuexiao',
				'report_url'      => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkabb&op=report&m=weixuexiao',
