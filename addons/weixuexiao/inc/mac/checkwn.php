	...
	if ($operation == 'notice') { //getNotice
		if(!empty($school)){
			...
			$result['data'] = array(
				...
				'consumptionurl'=>'',
				'brandurl'=>'',
                'getschoolinfo'  => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=login&m=weixuexiao',
                'getclassinfo'   => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=class&m=weixuexiao',
                'getstudentinfo' => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=users&m=weixuexiao',
                'posturl'        => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=check&m=weixuexiao',
                'leaveurl'       => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=getleave&m=weixuexiao',
                'outTimeUrl'     => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=class&m=weixuexiao',
                'commondurl'     => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=command&m=weixuexiao',
                'DeviceSetUrl'   => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=getdevremote&m=weixuexiao',
                'checkapUrl'     => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&op=checkap&m=weixuexiao',
                'getroomlisturl' => $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkxz&op=getroomlist&m=weixuexiao',
        ...
        if(empty($checkthisdata)){
			if(!empty($ckuser)){
				...
				if(!empty($_GPC['headerimg']) || !empty($_GPC['headerimg_second'])){
					...
					$path = "images/weixuexiao/checkwn/". date('Y/m/d/');
					$rand = random(30);
