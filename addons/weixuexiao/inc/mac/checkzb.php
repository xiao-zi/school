...
if ($operation == 'login') {
    if(!empty($ckmac)){
        ...
        $result['data']['onlineurl']       = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=online&m=weixuexiao');
        $result['data']['reporturl']       = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=report&m=weixuexiao');
        $result['data']['bannerurl']       = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=banner&m=weixuexiao');
        $result['data']['videourl']        = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=video&m=weixuexiao');
        $result['data']['classurl']        = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=class&m=weixuexiao');
        $result['data']['usersurl']        = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=users&m=weixuexiao');
        $result['data']['checkurl']        = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=check&m=weixuexiao');
        $result['data']['getleaveurl']     = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=getleave&m=weixuexiao');
        $result['data']['getroomlisturl']  = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=getroomlist&m=weixuexiao');
        $result['data']['getvisitorsurl']  = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=getvisitors&m=weixuexiao');
        $result['data']['reportvisitorsurl']  = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=reportvisitors&m=weixuexiao');
        $result['data']['allsyurl']  = urlencode($_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&op=allsy&m=weixuexiao');
        $result['code'] = 1000;
        $result['msg'] = "success";
        ...
        if($users){
            ...
            foreach($users as $key =>$row) {
                if($row['usertype'] == 1){
                    ...
                    $users[$key]['cid']          = '';
                    $users[$key]['type']         = 2;
                    $users[$key]['picrul']       = !empty($row['tpic']) ? tomedia($row['tpic']) : tomedia($teacher['thumb']);
