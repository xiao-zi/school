...
$goods = pdo_fetchall("SELECT id,title,thumb,old_price,new_price,qty,sold,cop,points FROM " . tablename($this->table_mall) . " where schoolid = '{$school_id}' And showtype != 0 ORDER BY sort DESC, id ASC");
