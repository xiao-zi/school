...
function sms_send($mobile, $content, $sms_SignName, $sms_templte, $type, $weid, $schoolid) {
    if($sms_templte && $sms_SignName){
        include IA_ROOT.'/addons/weixuexiao/inc/func/aliyun-php-sdk/aliyun-php-sdk-core/Config.php';
        include_once IA_ROOT.'/addons/weixuexiao/inc/func/aliyun-php-sdk/Dysmsapi/Request/V20170525/SendSmsRequest.php';
        include_once IA_ROOT .'/addons/weixuexiao/inc/func/aliyun-php-sdk/Dysmsapi/Request/V20170525/QuerySendDetailsRequest.php';
...
//        $Message = ($acsResponse->Message);
        ...
        if($Code == 'OK') {
            $status = 1;
            sms_insert_send_log($schoolid, $type, $mobile, 0, $status, 'OK');
        }else{
            $status = 2;
            sms_insert_send_log($schoolid, $type, $mobile, 0, $status, $Message);
        }
        $data['Code'] = $Code;
