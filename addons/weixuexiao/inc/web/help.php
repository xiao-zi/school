...
define('weixuexiao_AUTH_URL', 'http%3a%2f%2fauth.7mao.cc%2fapi%2fhelp.php');
$operation = empty($_GPC['op']) ? 'display' : $_GPC['op'];
$oauthurl = getoauthurl();
$versionfile = IA_ROOT . '/addons/weixuexiao/inc/version.php';
$versionfile2 = IA_ROOT . '/addons/weixuexiao/inc/func/auth2.php';
require $versionfile;
...
if ($operation == 'display') {
	...
	foreach($mycoludhelp as $key => $row){
		$resp = ihttp_post(urldecode(weixuexiao_AUTH_URL), array(
			'type' => 'checkhelpopen',
			'user' => $user,
			'ip' => $_W['clientip'],
			'oauthurl' => $oauthurl,
			'oauthurl2' => weixuexiao_HOST,
			'version' => $version,
