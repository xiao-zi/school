...
if($operation == 'post'){
    ...
    if(checksubmit('submit')){
        ...
        // $CheckSchoolSet = pdo_fetch("SELECT id FROM ".GetTableName('schoolset')." WHERE schoolid = '{$schoolid}' ");
        // if(empty($CheckSchoolSet)){
        //     $data2['schoolid'] = trim($id);
        //     $data2['weid'] = trim($weid);
        //     pdo_insert(GetTableName('schoolset',false), $data2);
        // }else{
