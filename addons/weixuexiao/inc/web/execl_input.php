 ...
 * @author 微学校团队
 */global $_W, $_GPC;
   $operation = in_array ( $_GPC ['op'], array ('default','export','input_cj','input_tea','input_teabj','input_teapf','input_stu','input_stupf','input_card','input_cardschool','input_kc','input_ks','input_scpy','input_buzhu','input_bjpf','input_stu_bj','input_chongzhi','input_linshichongzhi') ) ? $_GPC ['op'] : 'default';
	...
	if(!empty($strs[3])){
		...
		if(empty($banji['parentid']) || empty($banji)){
			...
			if(empty($student)){
				...
				if($checkcard){
					pdo_update($this->table_idcard, array('bj_id' => trim($banji['sid'])), array('sid' => $id));
				}
