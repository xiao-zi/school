    ...
    if(checksubmit('submit')){
        ...
        if(!empty($id)){
            ...
            if($data['macname'] != 1){
                if($data['macname'] == 2){
                    $mactype = 1;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkxz&m=weixuexiao';
                }
                if($data['macname'] == 3){
                    $mactype = 2;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&m=weixuexiao';
                }
                if($data['macname'] == 4){
                    $mactype = 3;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkabb&m=weixuexiao';
                }
                if($data['macname'] == 5){
                    $mactype = 4;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkhx&m=weixuexiao';
                }
                if($data['macname'] == 6){
                    $mactype = 5;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwn&m=weixuexiao';
                }
                if($data['macname'] == 7){
                    $mactype = 6;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkym&m=weixuexiao';
                ...
                if($data['macname'] == 11){
                    $mactype = 11;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkzb&m=weixuexiao';
                }
                if($data['macname'] == 12){
                    $mactype = 12;
                    $posturl = $_W['siteroot'] . 'app/index.php?i=' . $weid . '&c=entry&schoolid=' . $schoolid . '&do=checkwt&m=weixuexiao';
                }
